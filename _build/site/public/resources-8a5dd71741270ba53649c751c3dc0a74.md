...
- MyST Markdown / Jupyter Book for publishing notes.
- Python scientific stack: NumPy, pandas, scikit-learn, PyTorch/Lightning, ase/pymatgen.
- Workflow and experiment tracking: MLflow/Weights & Biases (pick one), DVC for data versioning.
